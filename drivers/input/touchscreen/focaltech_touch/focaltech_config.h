 ...
 */
#define FTS_VENDOR_1_ID                         0x11
#define FTS_VENDOR_2_ID                         0x12
#define FTS_VENDOR_3_ID                         0x13
 ...
 */
#define FTS_UPGRADE_FW_APP                      "include/firmware/FT3X68_20250324_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 2, fw corrsponding with FTS_VENDOR_2_ID
 * define your own fw_app, the sample one is invalid
 */
#define FTS_UPGRADE_FW2_APP                     "include/firmware/FT3X68_20250324_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM == 3, fw corrsponding with FTS_VENDOR_3_ID
 * define your own fw_app, the sample one is invalid
 */
#define FTS_UPGRADE_FW3_APP                     "include/firmware/FT3X68_20250324_app.i"
